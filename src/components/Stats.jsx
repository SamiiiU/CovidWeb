...
const Stats = () => {
  ...
  return (
    <div className='w-full text-center sm:h-screen px-20 py-12'>
      <h1 data-aos="fade-up" className='font-semibold text-purple-700 text-[6vw] sm:text-[3vw]'>Corona Virus Statistics</h1>
      <p data-aos="fade-up" className='text-zinc-700/50'> As of 2024, global statistics indicate over 770 m confirmed cases and more than 6.9 m deaths.</p>


      <div className='w-full flex flex-wrap gap-y-6 justify-between mt-20 items-center'>
        <div data-aos="zoom-in" className='sm:w-1/3 w-full flex-col flex items-center gap-y-5  justify-center '>
